...
# nerc-images/keycloak-permissions-operator-bundle:$VERSION and nerc-images/keycloak-permissions-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= nerc-images/keycloak-permissions-operator
